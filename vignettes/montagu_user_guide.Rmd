...
```r
cov_all <- montagu::montagu_coverage_data("IC-Garske", "201710gavi-5", "yf-routine-gavi", all_countries = TRUE)
cov_not <- montagu::montagu_coverage_data("IC-Garske", "201710gavi-5", "yf-routine-gavi", all_countries = FALSE)
c(nrow(cov_all$country), nrow(cov_not$country))
```
...
## 1 93  YFIC   test.user 2019-03-08T11:37:39.845Z      YF
## 2 92  YFIC   test.user 2019-03-08T11:36:20.585Z      YF
## 3 91  YFIC   test.user 2019-03-08T11:33:13.266Z      YF
## 4 90  YFIC   test.user 2019-02-27T11:18:17.036Z      YF
## 5 89  YFIC   test.user 2019-02-27T10:32:37.668Z      YF
## 6 88  YFIC   test.user 2019-02-27T10:30:12.324Z      YF
```
